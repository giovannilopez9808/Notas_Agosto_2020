...
plt.xlabel('$t$ (años)');plt.ylabel('$T$ (horas)')
plt.grid(ls="--",color="grey")
...
plt.ylim(0,100)
plt.xlabel('$e$',fontsize=14);plt.ylabel('$g$',fontsize=14)
plt.grid(ls="--",color="grey")
...
plt.xlabel('$e$');plt.ylabel('$a(10^{9})$')
...
plt.plot(t_exp,Delta_t_exp,'o',color="#1d4e89",label='Datos observacionales [12]')
