      ...
      real*8,dimension(:), allocatable :: x,y,vx,vy,fx,fy

      Integer (kind=8) :: npasos
      Integer (kind=8) :: i,k,j,iprint,n
      ...
      open(12,file=path//"dis_if"//version//".dat",status="unknown")
